(function () {
  ...
  const apiPath = window.BURGCALC_API_PATH || '/BURGCALC/api/calcular';

  const campos = [
    { name: 'pao', label: 'Custo do pão', step: '0.01', min: '0' },
  ...
  function Resultado({ resultado }) {
    ...
    const itens = [
      ['Custo total de produção', moeda(resultado.custoTotal)],
      ['Custo unitário', moeda(resultado.custoUnitario)],
      ['Preço de venda sugerido', moeda(resultado.precoVendaSugerido)],
